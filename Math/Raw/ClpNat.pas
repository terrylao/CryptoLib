...
type
  ...
  public
    ...
    class function equalTo(len:integer; x: TCryptoLibUInt32Array; y:integer):integer;overload; static;
    class function equalTo(len:integer; x:TCryptoLibUInt32Array; xOff, y:integer):integer;overload; static;
    class function equalTo(len:integer; x, y:TCryptoLibUInt32Array):integer;overload; static;
    class function equalTo(len:integer; x:TCryptoLibUInt32Array; xOff:integer;y:TCryptoLibUInt32Array;yOff:integer):integer;overload; static;
    class function equalToZero(len:integer; x:TCryptoLibUInt32Array):integer;overload; static;
    class function equalToZero(len:integer; x:TCryptoLibUInt32Array; xOff:integer):integer;overload; static;
  end;
...
begin
  TArrayUtils.Fill(z, zOff, zOff + len, UInt32(0));
    ...
    class function TNat.equalTo(len:integer; x: TCryptoLibUInt32Array; y:integer):integer;
      var
        i,d:integer;
    begin
        d := x[0] xor y;
        ...
        d := (d shr 1) or (d and 1);
        result := SarLongint((d - 1) , 31);
    end;

    class function TNat.equalTo(len:integer; x:TCryptoLibUInt32Array; xOff, y:integer):integer;
      var
        i,d:integer;
    begin
       d := x[xOff] xor y;
    ...
    class function TNat.equalTo(len:integer; x, y:TCryptoLibUInt32Array):integer;
      var
        i,d:integer;
    begin
        d := 0;
    ...
    class function TNat.equalTo(len:integer; x:TCryptoLibUInt32Array; xOff:integer ;y:TCryptoLibUInt32Array;yOff:integer):integer;
      var
        i,d:integer;
    begin
        d := 0;
        for i := 0  to len-1 do
        begin
            d := d or x[xOff + i] xor y[yOff + i];
        end;
        d := (d shr 1) or (d and 1);
        result := SarLongint((d - 1) , 31);
    end;

    class function TNat.equalToZero(len:integer; x:TCryptoLibUInt32Array):integer;
      var
        i,d:integer;
    begin
        d := 0;
    ...
    class function TNat.equalToZero(len:integer; x:TCryptoLibUInt32Array; xOff:integer):integer;
    var
      i,d:integer;
    begin
        d := 0;
