...
type
  ...
  public
    ...
    function getCurrentIV():TCryptoLibByteArray;virtual;abstract;
    function getCurrentKey():TCryptoLibByteArray;virtual;abstract;
    procedure changeIV(modifier:TCryptoLibByteArray);virtual;abstract;
