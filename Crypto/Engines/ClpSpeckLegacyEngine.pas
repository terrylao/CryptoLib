...
function TSpeckLegacyEngine.getCurrentIV():TCryptoLibByteArray;
begin
  // nothing to do.
end;
function TSpeckLegacyEngine.getCurrentKey():TCryptoLibByteArray;
begin
  result := nil;
end;
...
procedure TSpeckLegacyEngine.changeIV(modifier:TCryptoLibByteArray);
begin
  // nothing to do.
end;
