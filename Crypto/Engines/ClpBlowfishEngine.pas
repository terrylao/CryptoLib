...
function TBlowfishEngine.getCurrentIV():TCryptoLibByteArray;
begin
  // nothing to do.
end;
...
function TBlowfishEngine.getCurrentKey():TCryptoLibByteArray;
begin
  result := FWorkingKey;
end;
procedure TBlowfishEngine.changeIV(modifier:TCryptoLibByteArray);
begin
  // nothing to do.
end;
end.
