...
function TAesLightEngine.getCurrentIV():TCryptoLibByteArray;
begin
  // nothing to do.
end;
...
function TAesLightEngine.getCurrentKey():TCryptoLibByteArray;
begin
  result := nil;
end;
procedure TAesLightEngine.changeIV(modifier:TCryptoLibByteArray);
begin
  // nothing to do.
end;
end.
