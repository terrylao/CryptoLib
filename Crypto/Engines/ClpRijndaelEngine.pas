...
type
  ...
  var
    ...
    FWorkingKeyByteArray:TCryptoLibByteArray;
...
begin
  ...
  FWorkingKeyByteArray:=keyParameter.GetKey();
...
function TRijndaelEngine.getCurrentIV():TCryptoLibByteArray;
begin
  // nothing to do.
end;
function TRijndaelEngine.getCurrentKey():TCryptoLibByteArray;
begin
  result := FWorkingKeyByteArray;
end;
procedure TRijndaelEngine.Reset;
begin
  // nothing to do.
end;
procedure TRijndaelEngine.changeIV(modifier:TCryptoLibByteArray);
begin
  // nothing to do.
end;
end.
