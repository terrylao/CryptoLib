...
function TSpeckEngine.getCurrentIV():TCryptoLibByteArray;
begin
  // nothing to do.
end;
function TSpeckEngine.getCurrentKey():TCryptoLibByteArray;
begin
  result := nil;
end;
...
procedure TSpeckEngine.changeIV(modifier:TCryptoLibByteArray);
begin
  // nothing to do.
end;
{ TSpeckUInt32Engine }
